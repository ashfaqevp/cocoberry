...
public class adapterDialogSaleDate   extends RecyclerView.Adapter<adapterDialogSaleDate.itemViewholder> {
    ...
    onCreateViewHolder(@NonNull ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_dialog_sale, parent, false);
