...
public class adapterListFromAllOrders   extends RecyclerView.Adapter<adapterListFromAllOrders.itemViewholder> {
    ...
    public adapterListFromAllOrders
    ...
    onCreateViewHolder(@NonNull ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_from_all_orders, parent, false);
 ...
 */
    ...
    class itemViewholder extends RecyclerView.ViewHolder {
        ...
        public itemViewholder(@NonNull View itemView) {
            ...
            orderItem = itemView.findViewById(R.id.laoItem);
            orderQnty = itemView.findViewById(R.id.laoQnty);
